            ...
            <div class="col-md-4 col-vlg-3 col-sm-6">
              <div class="tiles green m-b-10">
                <div class="tiles-body">
                  ...
                  <div class="tiles-title text-black">整体销售 </div>
                  <div class="widget-stats">
                    <div class="wrapper transparent">
                      <span class="item-title">总访问量</span> <span class="item-count animate-number semi-bold" data-value="2415" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="widget-stats">
                    <div class="wrapper transparent">
                      <span class="item-title">今天的</span> <span class="item-count animate-number semi-bold" data-value="751" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="widget-stats ">
                    <div class="wrapper last">
                      <span class="item-title">每月</span> <span class="item-count animate-number semi-bold" data-value="1547" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="progress transparent progress-small no-radius m-t-20" style="width:90%">
                    <div class="progress-bar progress-bar-white animate-progress-bar" data-percentage="64.8%"></div>
                  </div>
                  <div class="description"> <span class="text-white mini-description ">比上个月上涨 <span class="blend">4%</span></span>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4 col-vlg-3 col-sm-6">
              <div class="tiles blue m-b-10">
                <div class="tiles-body">
                  ...
                  <div class="tiles-title text-black">总访问量 </div>
                  <div class="widget-stats">
                    <div class="wrapper transparent">
                      <span class="item-title">总访问量</span> <span class="item-count animate-number semi-bold" data-value="15489" data- animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="widget-stats">
                    <div class="wrapper transparent">
                      <span class="item-title">今天的</span> <span class="item-count animate-number semi-bold" data-value="551" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="widget-stats ">
                    <div class="wrapper last">
                      <span class="item-title">每月</span> <span class="item-count animate-number semi-bold" data-value="1450" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="progress transparent progress-small no-radius m-t-20" style="width:90%">
            ...
            <div class="col-md-4 col-vlg-3 col-sm-6">
              <div class="tiles purple m-b-10">
                <div class="tiles-body">
                  ...
                  <div class="tiles-title text-black">服务器负载 </div>
                  <div class="widget-stats">
                    <div class="wrapper transparent">
                      <span class="item-title">整体负载</span> <span class="item-count animate-number semi-bold" data-value="5695" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="widget-stats">
                    <div class="wrapper transparent">
                      <span class="item-title">今天的</span> <span class="item-count animate-number semi-bold" data-value="568" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="widget-stats ">
                    <div class="wrapper last">
                      <span class="item-title">每月</span> <span class="item-count animate-number semi-bold" data-value="12459" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="progress transparent progress-small no-radius m-t-20" style="width:90%">
            ...
            <div class="col-md-4 col-vlg-3 visible-xlg visible-sm col-sm-6">
              <div class="tiles red m-b-10">
                <div class="tiles-body">
                  ...
                  <div class="widget-stats">
                    <div class="wrapper transparent">
                      <span class="item-title">整体销售</span> <span class="item-count animate-number semi-bold" data-value="5669" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="widget-stats">
                    <div class="wrapper transparent">
              ...
              <div class="row">
                <div class="col-md-12" data-sync-height="true">
                  ...
                  <div class="tiles black">
                    <div class="tiles-body">
                      <h5 class="text-white"><span class="semi-bold">快速</span> 查看</h5>
                      <input type="text" placeholder="Search..." class="form-control input-sm m-t-20">
                      <div class="m-t-40">
                        <div class="widget-stats">
                          <div class="wrapper"> <span class="item-title">总访问量</span> <span class="item-count animate-number semi-bold" data-value="2415" data-animation-duration="700">0</span> </div>
                        </div>
                        <div class="widget-stats">
                          <div class="wrapper"> <span class="item-title">今天的</span> <span class="item-count animate-number semi-bold" data-value="751" data-animation-duration="700">0</span> </div>
                        </div>
                        <div class="widget-stats hidden-sm">
                          <div class="wrapper last"> <span class="item-title">每月</span> <span class="item-count animate-number semi-bold" data-value="1547" data-animation-duration="700">0</span> </div>
                        </div>
                        <div class="progress transparent progress-small no-radius m-t-20" style="width:90%">
                ...
                <div class="row">
                  <div class="sales-graph-heading">
                    <div class="col-md-5 col-sm-5">
                      <h5 class="no-margin">你赚了</h5>
                      <h4><span class="item-count animate-number semi-bold" data-value="21451" data-animation-duration="700">0</span> 人民币</h4>
                    </div>
                    <div class="col-md-3 col-sm-3">
                      <p class="semi-bold">今天</p>
                      <h4><span class="item-count animate-number semi-bold" data-value="451" data-animation-duration="700">0</span> 人民币</h4>
                    </div>
                    <div class="col-md-4 col-sm-3">
                      <p class="semi-bold">这个月</p>
                      <h4><span class="item-count animate-number semi-bold" data-value="8514" data-animation-duration="700">0</span> 人民币</h4>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                </div>
                <h5 class="semi-bold m-t-30 m-l-30">最后的销售</h5>
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-vlg-4 col-sm-12 ">
              <div class="tiles overflow-hidden full-height tiles-overlay-hover m-b-10 widget-item">
                  ...
                  <div class="overlayer-wrapper">
                    <div class="tiles gradient-grey p-l-20 p-r-20 p-b-20 p-t-20"> <a href="#" class="hashtags transparent"> #citymax </a> <a href="#" class="hashtags transparent"> #new york city </a> <a href="#" class="hashtags transparent"> #amazing </a>
                      ...
                      <div class="profile-img-wrapper inline m-r-5">
                        <img src="../../assets/images/profiles/avatar_small.jpg" alt="" data-src="../../assets/images/profiles/avatar_small.jpg" data-src-retina="../../assets/images/profiles/avatar_small2x.jpg" width="35" height="35">
                      </div>
                ...
                <img src="../../assets/images/others/9.jpg" data-src="../../assets/images/others/9.jpg" data-src-retina="../../assets/images/others/rob.jpg" alt="" class="image-responsive-width hover-effect-img">
              </div>
            </div>
                  ...
                  <div class="live-tile slide ha " data-speed="750" data-delay="4000" data-mode="carousel">
                      ...
                      <div class="overlayer bottom-left fullwidth">
                        <div class="overlayer-wrapper">
                          <div class="user-comment-wrapper">
                            <div class="profile-wrapper"> <img src="../../assets/images/profiles/avatar_small.jpg" alt="" data-src="../../assets/images/profiles/avatar_small.jpg" data-src-retina="../../assets/images/profiles/avatar_small2x.jpg" width="35" height="35"> </div>
                            <div class="comment">
                    ...
                    <div class="slide-back ha tiles blue">
                      <div class="user-comment-wrapper m-t-20">
                        <div class="profile-wrapper"> <img src="../../assets/images/profiles/d.jpg" alt="" data-src="../../assets/images/profiles/d.jpg" data-src-retina="../../assets/images/profiles/d2x.jpg" width="35" height="35"> </div>
                        <div class="comment">
                ...
                <div class="col-md-6  col-sm-6 m-b-10" data-aspect-ratio="true">
                  <div class="live-tile slide ha" data-speed="750" data-delay="4500" data-mode="carousel">
                      ...
                      <div class="overlayer bottom-left fullwidth">
                        <div class="overlayer-wrapper">
                          <div class="p-t-20 p-l-20 p-r-20 p-b-20">
                            ...
                            <p>2,567 人民币 <span class="m-l-10"><i class="fa fa-sort-desc"></i> 2%</span></p>
                            <p class="bold p-t-15">Front-end Design</p>
                            <p>1,420 人民币 <span class="m-l-10"><i class="fa fa-sort-desc"></i> 1%</span></p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="slide-back ha tiles green">
                      <div class="p-t-20 p-l-20 p-r-20 p-b-20">
                        <h5 class="text-white semi-bold no-margin p-b-5">今天 Sale's</h5>
                        <h3 class="text-white no-margin">450 <span class="semi-bold">人民币</span></h3> 最后的销售 23.45 人民币
                      </div>
                      <div class="overlayer bottom-left fullwidth">
                        <div class="overlayer-wrapper">
                ...
                <div class="col-md-6  col-sm-6 m-b-10" data-aspect-ratio="true">
                  <div class="live-tile slide ha " data-speed="750" data-delay="6000" data-mode="carousel">
                    <div class="slide-front ha tiles green ">
                      ...
                      <img src="../../assets/images/others/11.png" alt="" class="image-responsive-width xs-image-responsive-width"> </div>
                    <div class="slide-back ha tiles green">
                      <div class="overlayer bottom-left fullwidth">
                        <div class="overlayer-wrapper">
                          <div class="tiles gradient-black p-l-20 p-r-20 p-b-20 p-t-20">
                      ...
                      <img src="../../assets/images/others/cover.jpg" alt="" class="image-responsive-width xs-image-responsive-width">
                    </div>
                  </div>
                </div>
                <!-- END ANIMATED TILE -->
                  ...
                  <div class="tiles white add-margin">
                    <div class="p-t-20 p-l-20 p-r-20 p-b-20">
                      <div class="row b-grey b-b xs-p-b-20">
                        ...
                        <div class="col-md-3 col-sm-3">
                          <div class="m-t-20">
                            <h5 class="text-black semi-bold">今天</h5>
                      ...
                      <div class="widget-item ">
                        ...
                        <div class="tiles white p-t-15">
                          <div class="row">
                            <div class="col-md-2">
                              <div class="profile-img-wrapper pull-left m-l-10">
                                <div class=" p-r-10">
                                  <img src="../../assets/images/profiles/c.jpg" alt="" data-src="../../assets/images/profiles/c.jpg" data-src-retina="../../assets/images/profiles/c2x.jpg" width="35" height="35"> </div>
                              </div>
                            </div>
                            <div class="col-md-10">
                          ...
                          <div id="image-demo-carl-2" class="m-t-15 owl-carousel owl-theme">
                            <div class="item"><img src="../../assets/images/others/1.jpg" alt=""></div>
                            <div class="item"><img src="../../assets/images/others/2.jpg" alt=""></div>
                          </div>
                          ...
                          <div class="p-b-10 p-l-10 p-r-10">
                            <div class="profile-img-wrapper pull-left"> <img src="../../assets/images/profiles/avatar_small.jpg" alt="" data-src="../../assets/images/profiles/avatar_small.jpg" data-src-retina="../../assets/images/profiles/avatar_small2x.jpg" width="35" height="35"> </div>
                    ...
                    <div class="col-md-12 m-b-10">
                      <div class="widget-item ">
                        ...
                        <div class="tiles green  overflow-hidden full-height" style="max-height:214px">
                          ...
                          <img src="../../assets/images/others/10.png" alt="" class="lazy hover-effect-img"> </div>
                        <div class="tiles white ">
                          <div class="tiles-body">
                            <div class="row">
                            ...
                            <div class="row">
                              <div class="user-comment-wrapper pull-left">
                                <div class="profile-wrapper">
                                  <img src="../../assets/images/profiles/d.jpg" alt="" data-src="../../assets/images/profiles/d.jpg" data-src-retina="../../assets/images/profiles/d2x.jpg" width="35" height="35">
                                </div>
                                <div class="comment">
                        ...
                        <div class="tiles white p-t-15">
                          <div class="row">
                            <div class="col-md-2">
                              <div class="profile-img-wrapper pull-left m-l-10">
                                <div class=" p-r-10">
                                  <img src="../../assets/images/profiles/h.jpg" alt="" data-src="../../assets/images/profiles/h.jpg" data-src-retina="../../assets/images/profiles/h2x.jpg" width="35" height="35">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-10">
                          ...
                          <div class="p-b-10 p-l-10 p-r-10">
                            <div class="profile-img-wrapper pull-left">
                              <img width="35" height="35" alt="" src="../../assets/images/profiles/e.jpg" data-src="../../assets/images/profiles/e.jpg" data-src-retina="../../assets/images/profiles/e2x.jpg"> </div>
                            <div class="inline pull-right" style="width:86%">
                              <div class="input-group transparent ">
                                <input type="text" class="form-control" placeholder="Write a comment">
                                <span class="input-group-addon"> <i class="fa fa-camera"></i> </span> </div>
          ...
          <div class="chat-window-wrapper scroller scrollbar-dynamic" id="chat-users">
            ...
            <div class="side-widget fadeIn">
              ...
              <div id="favourites-list">
                <div class="side-widget-content">
                  <div class="user-details-wrapper active" data-chat-status="online" data-chat-user-pic="../../assets/images/profiles/d.jpg" data-chat-user-pic-retina="../../assets/images/profiles/d2x.jpg" data-user-name="Jane Smith">
                  ...
                  <div class="user-details-wrapper" data-chat-status="busy" data-chat-user-pic="../../assets/images/profiles/d.jpg" data-chat-user-pic-retina="../../assets/images/profiles/d2x.jpg" data-user-name="David Nester">
                    <div class="user-profile">
                      <img src="../../assets/images/profiles/c.jpg" alt="" data-src="../../assets/images/profiles/c.jpg" data-src-retina="../../assets/images/profiles/c2x.jpg" width="35" height="35">
                    </div>
                    <div class="user-details">
                      <div class="user-name">
                        David Nester
            ...
            <div class="side-widget">
              ...
              <div class="side-widget-content" id="friends-list">
                <div class="user-details-wrapper" data-chat-status="online" data-chat-user-pic="../../assets/images/profiles/d.jpg" data-chat-user-pic-retina="../../assets/images/profiles/d2x.jpg" data-user-name="Jane Smith">
                  <div class="user-profile">
                    <img src="../../assets/images/profiles/d.jpg" alt="" data-src="../../assets/images/profiles/d.jpg" data-src-retina="../../assets/images/profiles/d2x.jpg" width="35" height="35">
                  </div>
                  <div class="user-details">
          ...
          <div class="chat-window-wrapper" id="messages-wrapper" style="display:none">
            ...
            <div class="chat-messages scrollbar-dynamic clearfix">
              <div class="inner-scroll-content clearfix">
                ...
                <div class="sent_time ">今天 11:25pm</div>
